...
if (!isset($_SESSION['logged_in']) || $_SESSION['role'] !== 1) {
    ...
    // Használjuk a config.php-ban definiált okos átirányítást
...
<div class="glass-card">
    ...
    <form method="GET" action="<?php echo $base_url; ?>dolgozok" class="search-container">
        ...
        <a href="<?php echo $base_url; ?>dolgozok?export=txt&search=<?php echo urlencode($search); ?>" class="btn btn-secondary"><i class="fas fa-file-export"></i>&nbsp;TXT Export</a>
    </form>
